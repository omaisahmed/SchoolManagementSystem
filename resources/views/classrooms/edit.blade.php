    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title mt-3">Edit Class Room</h4>
            </div>
        </div>
...
@endif
                   ...
                   {{ method_field("PUT") }}
                        <div class="form-group mb-0">
                            <label class="mb-2 pb-1">Class Room Name</label>
                            <input type="text" name="classroom_name" value="{{ $classroom->classroom_name }}" class="form-control" required placeholder="Class Room Name"/>
                        </div>
